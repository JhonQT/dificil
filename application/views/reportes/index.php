...
<canvas id="chart1" style="background-color:#90C0BB; width:100%;" height="500%"></canvas>
<script>
...
<canvas id="chart2" style="background-color:#B6BEBD; width:100%;" height="500%"></canvas>
<script>
...
<canvas id="chart3" style="background-color:#D7E394; width:100%;" height="500%"></canvas>
<script>
...
<canvas id="chart4" style="background-color:#B5ABCF; width:100%; height=500%"></canvas>
<script>
